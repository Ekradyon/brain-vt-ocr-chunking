...
- `oid` es el identificador principal del proceso y se usa tambien como `documento_id` interno.
...
```json
{"status":"COMPLETED","exitoso":true,"data":{"stage":"pipeline","oid_documento":2299268,"inserted_rows":32}}
```
